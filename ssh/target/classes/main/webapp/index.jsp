...
<s:form action="employee_login" method="post" namespace="/">
    <div class="loginBox">
        ...
        <div class="login_cont">
            <ul class="login">
                <li class="l_tit" style="margin-left: 10px;margin-bottom: 10px">用户名</li>
                <li class="mb_10"><input type="text" id="username" name="username" class="login_input user_icon" autofocus placeholder="请输入用户名"></li>
                <li class="l_tit">密码</li>
                <li class="mb_10"><input type="password"  name="password" class="login_input user_icon" autofocus placeholder="请输入密码"></li>
                <li>
                    验证码：<input type="text" maxlength="4" name="checkCode" size="10"/>&nbsp;&nbsp;
                    <img alt="验证码" id="image" src="${pageContext.request.contextPath}/createImage_verifyCode"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="javascript:refresh();">看不清</a></br>
                </li>
